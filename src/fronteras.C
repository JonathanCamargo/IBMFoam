...
using namespace Tera;
	...
	void Tera::velNodoSuperior(double g[19], double f[19], double U, double V, double W)
	{
	...
	void Tera::velNodoInferior(double g[19], double f[19], double U, double V, double W)
	{
		// Calculate new distributions functions
		g=f;
		double A=0.0, B=0.0, rho=0.0, Nx=0.0, Ny=0.0;
	...
	void Tera::velNodoIzquierdo(double g[19], double f[19], double U, double V, double W)
	{
		// Calculate new distributions functions
		g=f;
	...
	void Tera::velNodoDerecho(double g[19], double f[19], double U, double V, double W)
	{
		// Calculate new distributions functions
		g=f;
		double A=0.0, B=0.0, rho=0.0, xNy=0.0, xNz=0.0;
