...
*/
void Tera::spread(fluid fluido, mesh membrana, int x, int y, int z)
{
...
*/
void Tera::interpolation(fluid fluido, mesh membrana, int x, int y, int z)
{
