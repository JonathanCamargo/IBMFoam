	...
	*/
	...
	void Tera::fuerzas(double referencia[3][3], double deformado[3][3], double fuerzas[3][3], double ks)
	{
	...
	*/
	void Tera::cross(double a[3], double b[3], double &x, double &y, double &z)
	{
		x = a[1]*b[2] - a[2]*b[1];
		y = a[2]*b[0] - a[0]*b[2];
		z = a[0]*b[1] - a[1]*b[0];
	...
	*   @param V[3], Vector de tamaño 3
	*/
	void Tera::MdotV(double M[3][3], double V[3], double &x, double &y, double &z)
	{
	...
	*/
	...
	void Tera::rotacion(double referencia[3][3], double deformado[3][3], double nfuerzas[3][3], double ks)
	{
